...
class TaskPlanner():
    ...
    def __init__(self,ip,fp):
        ...
        self.gripper.connect('192.168.1.19', 63352)
        print("Activating gripper...")
        self.gripper.activate()

        self.grip_state = 255 # CHANGE THIS
    ...
    def LaunchPickAndPlace(self, cmdr,workstate, hub, pose, tol, complete_move, complete_move_type,speed,corner_smoothing,project):
        ...
        if(self.grip_state == 0):
            ...
            self.grip_state = 0
        self.gripper.move_and_wait_for_pos(self.grip_state, 255, 0)
    ...
    def start(self):
        ...
        hub_1 = ['low_left', 'low_center', 'low_right', 'front_right', 'front_left', 'low_left']
                    ...
                    if res:
                        ...
                        if code == self.cmdr.SUCCESS:
                            if not self.interlocking[project_idx]:
                                ...
                                # CHANGE THIS HACK
                                if(self.hub_idxs[project_idx] == 5):
                                    self.hub_idxs[project_idx] = 0
